...
using EP.CMS.Presentation.Web.Filters;
using EP.CMS.Presentation.Web.Models;
...
namespace EP.CMS.Presentation.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            {
                var user = _userServices.GetUser(model.UserName);
                string userData = model.UserName + "," + user.Role;
                ...
                ElmahLog.Create("Successful Login by user: " + model.UserName);
                return RedirectToLocal(returnUrl);
            }
            ElmahLog.Create("Failed Login by User: " + model.UserName + ", Password : " + model.Password);
        ...
        public ActionResult Manage(LocalPasswordModel model)
        {
            ...
            if (hasLocalAccount)
            {
                if (ModelState.IsValid)
                {
                    ...
                    try
                    {
                        changePasswordSucceeded = _userServices.ChangePassword(User.Identity.Name, model.OldPassword, model.NewPassword);
                    }
                    catch (Exception)
                    {
